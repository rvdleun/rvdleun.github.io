export const Data = {
  aboutMe: {
    ...
    description: {
      en: [
        "When I join your team, you will get a fairly geeky developer. I have an innate enthusiasm for software engineering that comes with my upbringing, and I bring that with me into my work. One keyword you will find me repeating a lot is 'Responsibility', meaning that I prefer to write scripts, functions, and components that generally have a single focus. Allow me to add unit tests and stories to make sure they do their tasks well (now and in the future), and I will end my day on a very satisfied note.",
        "I prefer to be a team player. If I have an opinion about a topic, I will voice it and try to bring in my arguments for what I prefer. However, if someone brings up counter-arguments that change my view on something (which happens more often with junior developers than I care to admit) or if it would be too time-consuming with a deadline in mind, I'm more than willing to compromise or go for a different approach.",
        "Another topic I will also bring up a lot is Augmented and Virtual Reality. It's a topic I'm incredibly passionate about. I was psyched when I first got to try a headset at an HCC conference in 1997. When the VR hype began with the Oculus Quest, I've been developing for it ever since.",
        "I've also definitely fallen into the AI rabbit hole. While I have used OpenAI for professional projects, my personal ones tend to use self-hosted models.",
      ],
      nl: [
        "Wanneer ik bij jullie team kom, krijgen jullie een behoorlijk geekige ontwikkelaar. Ik heb een aangeboren enthousiasme voor software-engineering dat voortkomt uit mijn opvoeding, en ik neem dat mee in mijn werk. Een sleutelwoord dat je me veel zult horen herhalen is 'Verantwoordelijkheid', wat betekent dat ik liever scripts, functies en componenten schrijf die over het algemeen één focus hebben. Laat me unittests en stories toevoegen om ervoor te zorgen dat ze hun taken goed uitvoeren (nu en in de toekomst), en ik zal mijn dag op een zeer tevreden noot eindigen.",
        "Ik ben bij voorkeur een teamspeler. Als ik een mening heb over een onderwerp, zal ik die uiten en proberen mijn argumenten aan te dragen voor wat ik verkies. Als iemand echter tegenargumenten aandraagt die mijn visie op iets veranderen (wat vaker gebeurt met junior ontwikkelaars dan ik wil toegeven) of als het te tijdrovend zou zijn met een deadline in gedachten, ben ik meer dan bereid om compromissen te sluiten of een andere aanpak te kiezen.",
        "Een ander onderwerp dat ik ook veel ter sprake zal brengen is Augmented en Virtual Reality. Het is een onderwerp waar ik ongelooflijk gepassioneerd over ben. Ik was enthousiast toen ik voor het eerst een headset mocht proberen op een HCC-conferentie in 1997. Toen de VR-hype begon met de Oculus Quest, ben ik er sindsdien voor aan het ontwikkelen.",
        "Ik ben ook zeker in het AI-wereld gevallen. Hoewel ik OpenAI heb gebruikt voor professionele projecten, gebruiken mijn persoonlijke projecten de voorkeur voor zelf-gehoste modellen.",
      ],
    },
  },
  experiences: [
    ...
    },
    {
      ...
      description: {
        en: [
          ...
          "For XR Academy, I improved the maintainability of the code by moving everything into a monorepo, cleaning up the codebase, and setting up a CMS using Strapi to maintain content.",
        ...
        nl: [
          ...
          "Voor XR Academy heb ik de onderhoudbaarheid van de code verbeterd door alles naar een monorepo te verplaatsen, de codebase op te schonen en een CMS op te zetten met behulp van Strapi om content te beheren.",

      ...
      <Category title={{ nl: "Persoonlijke gegevens", en: "About me" }}>
        <div className="flex justify-between">
          <div>
            ...
            <div className="mb-2">
              <FieldValue
                field={{ nl: "Geboortedatum", en: "Birthdate" }}
                value={aboutMe.birthDate}
              />
              <FieldValue
                field={{ nl: "Geboorteplaats", en: "Birthplace" }}
                value={aboutMe.birthPlace}
              />
              <FieldValue
                field={{ nl: "Nationaliteit", en: "Nationality" }}
                value={aboutMe.nationality}
              />
            </div>
            <div className="mb-2">
              <FieldValue
                field={{ nl: "Burgerlijke staat", en: "Martial status" }}
        ...
        <div>
          <div className="mb-2">
            <FieldValue
              ...
              value={aboutMe.recentUsedSkillsAndExpertise.join(", ")}
            />
          </div>
